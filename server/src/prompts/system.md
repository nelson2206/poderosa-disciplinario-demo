...
4. **Tono condicional en la IMPUTACIÓN (Carta 1)**: "habría incurrido", "evidenciaría", "se habría identificado", "habría intervenido", "constituiría". Nunca afirmar la culpabilidad del trabajador en una carta de imputación. **EXCEPCIÓN — DECISIÓN FINAL (Carta 2)**: como se emite DESPUÉS del descargo, allí los hechos comprobados se **afirman/confirman** ("se identificó", "se verificó", "se constató", "se acreditó"), no en condicional.
